...
/// <summary>
/// SFGAO bitfield values represent attributes that can be retrieved on an item (file or folder)
/// or set of items. They are used with the IShellFolder and IShellItem APIs, most notably
/// IShellFolder::GetAttributesOf and IShellItem::GetAttributes.
/// </summary>
/// <remarks><a href="https://learn.microsoft.com/en-us/windows/win32/shell/sfgao"></a></remarks>
[Flags]
